...
public class PrimaryProperty extends Property
{
    ...
    public void addHouse(ZagopolyTextWindow TextWindow)
    {
        ...
        {
            NUM_HOUSES++;
            TextWindow.printMessage("House added!");
        }
        else{
    ...
    public void removeHouse(ZagopolyTextWindow TextWindow)
    {
        if(NUM_HOUSES > 0)
            ...
            TextWindow.printMessage("This property does not have any houses to remove.");
    }
    ...
    public void removeHotel(ZagopolyTextWindow TextWindow)
    {
        if(HOTEL)
            ...
            TextWindow.printMessage("This property does not have a hotel to remove.");
    }
